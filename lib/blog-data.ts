...
export const blogPosts: BlogPost[] = [
  {
    ...
    contentHTML: `
      ...
      <p>When the pandemic hit, these platforms were a lifeline. Today? They feel more like a permanent tax on your business. Let's break down the reality of relying on third-party aggregators versus taking back control with a first-party platform like <strong>O.App</strong>.</p>
      ...
      <p>A first-party ordering system is an app or website that belongs entirely to your restaurant. Customers order directly from you, not through an aggregator. This is where <strong>O.App</strong> comes in.</p>
      ...
      <p>When a customer orders through O.App, you get their data. You can build a database, understand their ordering habits, and run targeted marketing campaigns. If someone hasn't ordered in 30 days, you can automatically send them a "We miss you" discount. That's real power.</p>
      ...
      <p>By filtering traffic from the big aggregators into your own native <strong>O.App</strong> ecosystem, you get the absolute best of both worlds: discovery from the giant monopolies, and scalable profitability from your own private platform.</p>
    `
  }
]
