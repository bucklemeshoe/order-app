...
async function handler(req: Request): Promise<Response> {
  ...
  try {
    ...
    if (!error) {
      ...
      // Debug: Fetch the created order to verify pickup_time was stored correctly
      ...
      if (!fetchError && createdOrder) {
        console.log('Order created successfully. Stored pickup_time:', createdOrder.pickup_time)
      }
    }
