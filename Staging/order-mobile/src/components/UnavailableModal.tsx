    ...
    <IonModal isOpen={isOpen} onDidDismiss={onDismiss}>
      <IonHeader>
        <IonToolbar className="bg-white border-b border-neutral-200">
          <IonTitle className="text-neutral-900">{unavailableInfo.title}</IonTitle>
          <IonButtons slot="end">
        ...
        <div className="flex flex-col items-center justify-center text-center px-6 py-8">
          ...
          <div className="mb-6">
            <IonIcon 
              ...
              className={`text-5xl ${outsideBusinessHours ? 'text-yellow-500' : 'text-neutral-400'}`}
              style={{ fontSize: '3rem' }}
            />
          </div>
          ...
          {outsideBusinessHours && businessHoursStatus ? (
            <div className="mb-6">
              <p className="text-neutral-700 mb-2 leading-relaxed text-sm">
          ...
          {/* Store Information */}
          <div className="bg-white border border-neutral-200 rounded-lg p-4 mb-6 w-full">
