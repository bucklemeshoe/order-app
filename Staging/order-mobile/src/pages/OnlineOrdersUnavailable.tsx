    ...
    <IonPage>
      <IonContent className="ion-padding">
        <div className="flex flex-col items-center justify-center min-h-full text-center px-6 pt-12">
          ...
          {/* Description */}
          <p className="text-neutral-600 mb-2 leading-relaxed max-w-sm text-sm">
            We're temporarily not accepting online orders right now.
          </p>
          
          <p className="text-neutral-600 mb-8 leading-relaxed max-w-sm text-sm">
          ...
          <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-8 max-w-sm w-full">
            <h3 className="font-semibold text-neutral-900 mb-2">Visit Our Store</h3>
