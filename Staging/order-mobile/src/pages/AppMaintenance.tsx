  ...
  return (
    <IonPage>
      <IonContent className="ion-padding">
        <div className="flex flex-col items-center justify-center min-h-full text-center px-6 pt-12">
          {/* Icon */}
          <div className="mb-8">
            <IonIcon 
              icon={construct} 
          ...
          {/* Description */}
          <p className="text-neutral-600 text-sm mb-2 leading-relaxed max-w-sm">
            We're currently performing maintenance to improve your experience.
          </p>
          
          <p className="text-neutral-600 text-sm mb-8 leading-relaxed max-w-sm">
          ...
          <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-8 max-w-sm w-full">
            <div className="flex items-center justify-center mb-2">
              <IonIcon icon={time} className="text-yellow-700 mr-2" />
              <h3 className="font-semibold text-neutral-900">Estimated Time</h3>
            </div>
            <p className="text-sm text-neutral-800 mb-3">
              Maintenance usually takes 5-15 minutes
            </p>
            <div className="text-xs text-neutral-900 bg-yellow-100 rounded px-2 py-1">
              Started at {new Date().toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' })}
            </div>
          </div>

          {/* What's Being Updated */}
          <div className="bg-white border border-neutral-200 rounded-lg p-4 mb-8 max-w-sm w-full">
            <h3 className="font-semibold text-neutral-900 mb-3">What We're Updating</h3>
          ...
          {/* Footer Message */}
          <p className="text-xs text-neutral-500 mt-6 max-w-sm">
