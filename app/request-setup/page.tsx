...
export const metadata = { title: 'Request Setup | O App' }
            ...
            <form className="space-y-6">
              <div className="grid sm:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <Input id="restaurantName" placeholder="E.g. The Daily Grind" className="h-12 rounded-xl bg-zinc-50 border-zinc-200 focus-visible:ring-brand" required />
                </div>
                <div className="space-y-2">
                  <Label htmlFor="ownerName" className="font-semibold text-zinc-900">Your Full Name *</Label>
                  <Input id="ownerName" placeholder="E.g. Sarah Smith" className="h-12 rounded-xl bg-zinc-50 border-zinc-200 focus-visible:ring-brand" required />
                </div>
              </div>
              ...
              <div className="grid sm:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <Input id="email" type="email" placeholder="sarah@example.com" className="h-12 rounded-xl bg-zinc-50 border-zinc-200 focus-visible:ring-brand" required />
                </div>
                <div className="space-y-2">
                  <Label htmlFor="phone" className="font-semibold text-zinc-900">WhatsApp Number *</Label>
                  <Input id="phone" type="tel" placeholder="+27 82 000 0000" className="h-12 rounded-xl bg-zinc-50 border-zinc-200 focus-visible:ring-brand" required />
                </div>
              </div>

              <div className="space-y-2">
                <Label htmlFor="menuLink" className="font-semibold text-zinc-900">Link to your current menu (Website, Instagram, PDF)</Label>
                <Input id="menuLink" type="url" placeholder="https://..." className="h-12 rounded-xl bg-zinc-50 border-zinc-200 focus-visible:ring-brand" />
              </div>

              <div className="space-y-2">
                <Label htmlFor="apps" className="font-semibold text-zinc-900">Do you currently use delivery apps? (UberEats, MrD, etc.)</Label>
                <Input id="apps" placeholder="E.g. Yes, we use UberEats and MrD" className="h-12 rounded-xl bg-zinc-50 border-zinc-200 focus-visible:ring-brand" />
              </div>

              <div className="space-y-2">
                <Label htmlFor="notes" className="font-semibold text-zinc-900">Any special requirements or notes?</Label>
                <Textarea id="notes" placeholder="Tell us if there's anything specific you need..." className="min-h-[120px] rounded-xl resize-y bg-zinc-50 border-zinc-200 focus-visible:ring-brand" />
              </div>

              <div className="pt-6">
                <Button className="w-full bg-brand hover:bg-brand/90 text-white rounded-full h-14 text-lg font-medium shadow-[0_8px_30px_rgb(248,61,96,0.3)] transition-all hover:-translate-y-0.5 active:translate-y-0 active:scale-[0.98]">
                  Submit Request
                </Button>
