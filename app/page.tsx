            ...
            <div className="text-center mb-16 max-w-4xl mx-auto">
              ...
              <p className="text-zinc-600 text-lg">
                <span className="relative inline-block mx-1">
                  ...
                  <svg className="absolute z-0 text-brand -top-4 -bottom-4 -left-5 -right-5 w-[calc(100%+40px)] h-[calc(100%+32px)] pointer-events-none opacity-80" viewBox="0 0 200 60" preserveAspectRatio="none" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                to delivery apps. Take back control of your customers and your margin with a beautiful system built just for you.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 max-w-6xl mx-auto items-center">
              ...
              <div className="grid grid-cols-2 gap-4 order-1 lg:order-2">
                ...
                <div className="space-y-4">
                   <div className="rounded-[2rem] overflow-hidden border border-white/10 aspect-[4/5] relative bg-zinc-900 shadow-2xl">
                     <Image src="/images/delivery-person.png" alt="Order delivery" fill className="object-cover object-bottom scale-[1.15]" />
                   </div>
                </div>
              </div>
            </div>
