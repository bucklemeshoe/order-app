...
// Replace next/image with native img for Vite/React
import { Pencil, Search, Filter, Coffee, MouseIcon as Mug, ChevronLeft, ChevronRight } from "lucide-react"
import { Input as BaseInput } from "./ui/input"
import { Button as BaseButton } from "./ui/button"
import { Table as BaseTable, TableBody as BaseTableBody, TableCaption as BaseTableCaption, TableCell as BaseTableCell, TableHead as BaseTableHead, TableHeader as BaseTableHeader, TableRow as BaseTableRow } from "./ui/table"
...
// Create inspectable versions of components (selective for better UX)
const Input = withInspector(BaseInput, 'Input')
const Button = withInspector(BaseButton, 'Button')
const Table = withInspector(BaseTable, 'Table')
// Skip TableBody, TableHeader, TableRow to avoid nesting conflicts
const TableCaption = withInspector(BaseTableCaption, 'TableCaption')
const TableCell = withInspector(BaseTableCell, 'TableCell')
const TableHead = withInspector(BaseTableHead, 'TableHead')
...
// Use base components for these to avoid nesting conflicts
const TableBody = BaseTableBody
const TableHeader = BaseTableHeader
                  ...
                  <TableCell>
                    <div className="relative h-10 w-10 overflow-hidden rounded-md bg-muted">
                       {it.imageUrl ? (
                         ...
                         <img src="/placeholder-0taew.png" alt="Placeholder coffee" className="object-cover h-full w-full" />
                       )}
                    </div>
                  </TableCell>
                  <TableCell
